...
import {IUserState, setIsAuthenticated, setUser} from "@/redux/features/userSlice";
...
const Header = () => {
    ...
    useEffect(() => {
        if (data) {
            dispatch(setUser(data?.user as IUserState));
            ...
            <div className="container">
                ...
                <div className="col-6 col-lg-3 mt-3 mt-md-0 text-end">
                    ...
                    {<>
                        ...
                        {data === null && (
                            <Link href="/login"
                                  className="btn btn-danger px-4 text-white login-header-btn float-right">Login</Link>
                        )}
                    </>}
                </div>
            </div>
